...
├── plot_networks.py                   <- visualizacion de arquitecturas (Perceptron, MLP1, MLP2)
├── dataset_clean.csv                  <- output de preprocessing.py (no incluido)
├── informe_taller1.docx               <- informe completo del taller
├── plots/                             <- graficas generadas (incl. 06_redes_neuronales.png)
...
# 4. (Opcional) Grafico de arquitecturas de red
python3 plot_networks.py   # genera plots/06_redes_neuronales.png
