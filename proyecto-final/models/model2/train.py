"""Entrenamiento del Modelo 2 (DeepCNN_BN o DeepCNN_BN_GAP).
...
# Permitir ejecución directa: `python models/model2/train.py ...`
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Entrena DeepCNN_BN o DeepCNN_BN_GAP.")
...
def main() -> None:
    ...
    _log(
        f"Arquitectura: {args.arch} | epochs={args.epochs} | "
        f"lr={args.lr} | bs={args.batch_size} | wd={args.weight_decay}"
    )
